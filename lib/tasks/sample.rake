namespace :sample do
  ...
  task demo: :environment do
    ...
    Product.create!([
       { id: 1, name: "Small", description: "Small EC2 Instance", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type_id: 1, setup_price: "1.99", hourly_price: "0.001", monthly_price: "0.05"},
       { id: 2, name: "Medium", description: "Medium EC2 Instance", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type_id: 1, setup_price: "2.99", hourly_price: "0.0025", monthly_price: "0.075"},
       { id: 3, name: "Large", description: "Large EC2 Instance", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type_id: 1, setup_price: "3.99", hourly_price: "0.0055", monthly_price: "0.12"},
       { id: 5, name: "Medium MySQL", description: "Medium MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "1.99", hourly_price: "0.004", monthly_price: "0.1"},
       { id: 6, name: "Medium PostgreSQL", description: "Medium PostgreSQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "2.99", hourly_price: "0.004", monthly_price: "0.25"},
       { id: 7, name: "Large PostgreSQL", description: "Large PostgreSQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "3.99", hourly_price: "0.009", monthly_price: "0.5"},
       { id: 8, name: "Medium Aurora", description: "Medium Aurora", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "4.99", hourly_price: "0.015", monthly_price: "0.95"},
       { id: 9, name: "Large SQL Server", description: "Large SQL Server", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "5.99", hourly_price: "0.025", monthly_price: "1.29"},
       { id: 11, name: "West Coast Storage", description: "Normal, Northern California", active: true, img: "products/aws_s3.png", deleted_at: nil, product_type_id: 4, setup_price: "0.99", hourly_price: "0.001", monthly_price: "0.05"},
       { id: 4, name: "Small MySQL", description: "Small MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type_id: 3, setup_price: "1.0", hourly_price: "1.0", monthly_price: "1.0"},
       { id: 16, name: "LAMP Stack", description: "Linux, Apache, MySQL, PHP", active: true, img: "products/php.png", deleted_at: nil, product_type_id: 5, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 17, name: "LAMP Stack", description: "Linux, Apache, MySQL, PHP", active: true, img: "products/php.png", deleted_at: nil, product_type_id: 5, setup_price: "20.0", hourly_price: "20.0", monthly_price: "20.0"},
       { id: 18, name: "Rails Stack", description: "Ruby on Rails Stack", active: true, img: "products/rails.png", deleted_at: nil, product_type_id: 5, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 19, name: "MEAN Stack", description: "MongoDB, ExpressJS, AngularJS, NodeJS.", active: true, img: "products/mean.png", deleted_at: nil, product_type_id: 5, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 20, name: "Sr. Java Developer", description: "", active: true, img: "products/woman.png", deleted_at: nil, product_type_id: 7, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 21, name: "Sr. System Administrator", description: "Sr. System Administrator", active: true, img: "products/woman.png", deleted_at: nil, product_type_id: 7, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 22, name: "Project Manager", description: "Project Manager", active: true, img: "products/man.png", deleted_at: nil, product_type_id: 7, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 23, name: "JIRA Project", description: "A project in corporate JIRA instance.", active: true, img: "products/jira.png", deleted_at: nil, product_type_id: 6, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 24, name: "Confluence Project", description: "Confluence Project", active: true, img: "products/confluence.png", deleted_at: nil, product_type_id: 6, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 25, name: "Bugzilla Instance", description: "Bugzilla Instance", active: true, img: "products/bugzilla.png", deleted_at: nil, product_type_id: 6, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 26, name: "1GB NetApps Storage", description: "NetApps Storage", active: true, img: "products/netapp.png", deleted_at: nil, product_type_id: 4, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 10, name: "S3 Storage", description: "", active: true, img: "products/aws_s3.png", deleted_at: nil, product_type_id: 4, setup_price: "1.0", hourly_price: "1.0", monthly_price: "1.0"},
       { id: 28, name: "Teradata", description: "Teradata", active: true, img: "products/teradata.png", deleted_at: nil, product_type_id: 2, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 31, name: "RHEL 6 Large ", description: "Large RHEL 6 Instance", active: true, img: "products/redhat.png", deleted_at: nil, product_type_id: 1, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 32, name: "RHEL 6 Medium", description: "RHEL 6 Medium", active: true, img: "products/redhat.png", deleted_at: nil, product_type_id: 1, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 30, name: "RHEL 6 Small ", description: "Small RHEL 6 Instance", active: true, img: "products/redhat.png", deleted_at: nil, product_type_id: 1, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 33, name: "Apache Web Server ", description: "Apache Web Server", active: true, img: "products/apache.png", deleted_at: nil, product_type_id: 1, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 34, name: "MS Exchange Server", description: "MS Exchange Server", active: true, img: "products/exchange.png", deleted_at: nil, product_type_id: 5, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 27, name: "100 Node Hadoop Cluster", description: nil, active: true, img: "products/hadoop.png", deleted_at: nil, product_type_id: 2, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"},
       { id: 29, name: "10 Node Hadoop Cluster", description: nil, active: true, img: "products/hadoop.png", deleted_at: nil, product_type_id: 2, setup_price: "10.0", hourly_price: "10.0", monthly_price: "10.0"}
    ])
