namespace :sample do
  ...
  task demo: :environment do
    ...
    Product.create!([
      { id: 1, name: "AWS Small", description: "t2.small EC2", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type: "AWS Fog Infrastructure", setup_price: 0.0, hourly_price: 0.026, monthly_price: 0.0, provisioning_answers: '{"flavor_id":"t1.micro","disk_size":"20"}'},
      { id: 2, name: "AWS Medium", description: "m3.medium EC2", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type: "AWS Fog Infrastructure", setup_price: 0.0, hourly_price: 0.080, monthly_price: 0.0, provisioning_answers: '{"flavor_id":"m3.medium","disk_size":"20"}'},
      { id: 3, name: "AWS Large", description: "m3.large EC2", active: true, img: "products/aws_ec2.png", deleted_at: nil, product_type: "AWS Fog Infrastructure", setup_price: 0.0, hourly_price: 0.13, monthly_price: 0.14, provisioning_answers: '{"flavor_id":"m3.large","disk_size":"20"}'},
      ...
      { id: 10, name: "AWS S3 Bucket", description: "", active: true, img: "products/aws_s3.png", deleted_at: nil, product_type: "AWS Fog Storage", setup_price: "1.0", hourly_price: "1.0", monthly_price: "1.0" },
      ...
      { id: 43, name: "AWS Small MySQL", description: "t2.small MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type: "AWS Fog Databases", setup_price: 0.0, hourly_price: 0.034, monthly_price: 0.0, provisioning_answers: '{"DBInstanceClass":"db.t2.small","AllocatedStorage":"20","StorageType":"standard","availability":"reduced","Engine":"mysql"}' },
      { id: 44, name: "AWS Medium MySQL", description: "m3.medium MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type: "AWS Fog Databases", setup_price: 0.0, hourly_price: 0.090, monthly_price: 0.0, provisioning_answers: '{"DBInstanceClass":"db.m3.medium","AllocatedStorage":"40","StorageType":"standard","availability":"reduced","Engine":"mysql"}' },
      { id: 45, name: "AWS Large MySQL", description: "m3.large MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type: "AWS Fog Databases", setup_price: 0.0, hourly_price: 0.185, monthly_price: 0.0, provisioning_answers: '{"DBInstanceClass":"db.m3.large","AllocatedStorage":"60","StorageType":"standard","availability":"reduced","Engine":"mysql"}' },
      { id: 46, name: "Windows Server 2012", description: "Windows Server 2012 R2 Datacenter", active: true, img: "products/windows.png", deleted_at: nil, product_type: "Azure Fog Infrastructure", setup_price: 0.0, hourly_price: 0.077, monthly_price: 0.0, provisioning_answers: '{"image":"a699494373c04fc0bc8f2bb1389d6106__Win2K8R2SP1-Datacenter-201504.01-en.us-127GB.vhd","vm_name":"fogvmclone","vm_user":"jellyfish","location":"West US","password":"ComplexPassword!123","storage_account_name":"fogvmclonestorage"}' }
    ])
